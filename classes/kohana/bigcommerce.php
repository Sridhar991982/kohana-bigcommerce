...
require_once (Kohana::find_file('vendor/bigcommerce/Api', 'Connection'));
require_once (Kohana::find_file('vendor/bigcommerce/Api', 'Resources'));
require_once (Kohana::find_file('vendor/bigcommerce/Api', 'Filter'));

/**
 * BigCommerce API wrapper.
 */
class Kohana_Bigcommerce
{
